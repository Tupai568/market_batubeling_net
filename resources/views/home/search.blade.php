						...
						<div class="product-showcase">
							...
							<div class="showcase-wrapper">
								<div class="showcase-container unggulan-container">
									...
									<div class="showcase">
										<a href="{{ route('detail-product', ['name' => $limit->produk->name, 'id' => $limit->produk->id]) }}" class="showcase-img-box">
											<img
												src="{{ asset("img/produk/".$limit->produk->image->image) }}"
										...
										<div class="showcase-content">
											<a href="{{ route('detail-product', ['name' => $limit->produk->name, 'id' => $limit->produk->id]) }}">
												<h4 class="showcase-title">{{ $limit->produk->name }}</h4>
											</a>

											<div class="price-box">
												<p class="price">RP.{{ $limit->produk->harga }}</p>
											</div>
										</div>
									</div>
									@endforeach
