					...
					<div class="slider-container has-scrollbar swiper-wrapper">
						...
						<div class="slider-item swiper-slide">
								<a href="{{ route("store.products", ["profile" => $baner->user->profile]) }}">
									<img src="{{ asset("img/baner/".$baner->image) }}" alt="women's latest fashion sale" class="banner-img" />
								</a>
						</div>
						@endforeach
						<div class="slider-item swiper-slide">
								{{-- <a href="{{ route("store.products", ["profile" => $baner->user->profile]) }}"> --}}
									<img src="{{ asset("img/ALMAAS.jpg") }}" alt="women's latest fashion sale" class="banner-img" />
								{{-- </a> --}}
						</div>
					</div>
				</div>
							...
							<div class="product-showcase">
								...
								<div class="showcase-wrapper has-scrollbar">
											...
											<div class="showcase">
												...
												<div class="showcase-content">
													<a href="{{ route('detail-product', ['name' => $limit->name, 'id' => $limit->id]) }}">
														...
														<a href="{{ route('detail-product', ['name' => $limit->name, 'id' => $limit->id]) }}" class="showcase-category">{{ $limit->kategori->name }}</a>
									...
									<div class="showcase-container">
										...
										<div class="showcase">
											<a href="{{ route('detail-product', ['name' => $slice->name, 'id' => $slice->id]) }}" class="showcase-img-box">
												<img
													src="{{ asset("img/produk/".$slice->image->image) }}"
													alt="{{ $slice->name }}"
													class="showcase-img"
													width="70"
												/>
											...
											<div class="showcase-content">
												...
												<a href="{{ route('detail-product', ['name' => $slice->name, 'id' => $slice->id]) }}" class="showcase-category">{{ $slice->kategori->name }}</a>
								...
								<div class="showcase-wrapper has-scrollbar">
									<div class="showcase-container">
										@foreach ($limitsTrending as $limitTrending)
											<div class="showcase">
												<a href="{{ route('detail-product', ['name' => $limitTrending->name, 'id' => $limitTrending->id]) }}" class="showcase-img-box">
													<img
														src="{{ asset("img/produk/".$limitTrending->image->image) }}"
														alt="{{ $limitTrending->name }}"
														width="70"
														class="showcase-img"
													/>
												</a>
												...
												<div class="showcase-content">
													<a href="{{ route('detail-product', ['name' => $limitTrending->name, 'id' => $limitTrending->id]) }}">
														...
														<a href="{{ route('detail-product', ['name' => $limitTrending->name, 'id' => $limitTrending->id]) }}" class="showcase-category">{{ $limitTrending->kategori->name }}</a>
									...
									<div class="showcase-container">
										...
										<div class="showcase">
											<a href="{{ route('detail-product', ['name' => $sliceTrending->name, 'id' => $sliceTrending->id]) }}" class="showcase-img-box">
												<img
													src="{{ asset("img/produk/".$sliceTrending->image->image) }}"
													alt="{{ $sliceTrending->name }}"
													class="showcase-img"
													width="70"
												/>
											</a>
											...
											<div class="showcase-content">
												...
												<a href="{{ route('detail-product', ['name' => $sliceTrending->name, 'id' => $sliceTrending->id]) }}" class="showcase-category">{{ $sliceTrending->kategori->name }}</a>
								...
								<div class="showcase-wrapper has-scrollbar">
									<div class="showcase-container">
										@foreach ($limitsLike as $like)
											<div class="showcase">
												<a href="{{ route('detail-product', ['name' => $like->name, 'id' => $like->id]) }}" class="showcase-img-box">
													<img
														src="{{ asset("img/produk/".$like->image->image) }}"
														alt="{{ $like->name }}"
														width="70"
														class="showcase-img"
													/>
												...
												<div class="showcase-content">
													<a href="{{ route('detail-product', ['name' => $like->name, 'id' => $like->id]) }}">
														...
														<a href="{{ route('detail-product', ['name' => $like->name, 'id' => $like->id]) }}" class="showcase-category">{{ $like->kategori->name }}</a>
									...
									<div class="showcase-container">
										...
										<div class="showcase">
											<a href="{{ route('detail-product', ['name' => $slicesLike->name, 'id' => $slicesLike->id]) }}" class="showcase-img-box">
												<img
													src="{{ asset("img/produk/".$slicesLike->image->image) }}"
													alt="{{ $slicesLike->name }}"
													class="showcase-img"
													width="70"
												/>
											...
											<div class="showcase-content">
												...
												<a href="{{ route('detail-product', ['name' => $slicesLike->name, 'id' => $slicesLike->id]) }}" class="showcase-category">{{ $slicesLike->kategori->name }}</a>
								...
								<div class="showcase">
									<div class="showcase-banner">
										...
										<div class="showcase-actions">
											@auth
											<button class="btn-action btn-action-heart  {{ $product->like ? 'like':''}}" data-product={{ $product->id }}>
